...
NSInteger SISGetHWNCPU(void) {
    // Specifier: "hw.ncpu".
    return (NSInteger)_SISInt64ForSpecifier("hw.ncpu");
}
...
NSInteger SISGetHWPageSize(void) {
    // Specifier: "hw.pagesize"
    return (NSInteger)_SISInt64ForSpecifier("hw.pagesize");
}
